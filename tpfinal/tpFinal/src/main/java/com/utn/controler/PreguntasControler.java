...
public class PreguntasControler {
	...
	public String getRespuestaById(@PathVariable("pregunta") @PathVariable("respuesta")  String pregunta, String respuesta)
	{
		PreguntaDAO pdaoDao = PreguntaDAO.createInstance();
		Pregunta preg=new Pregunta(pregunta,respuesta);
